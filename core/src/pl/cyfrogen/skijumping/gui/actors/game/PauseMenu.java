...
public class PauseMenu extends Group {
    ...
    public PauseMenu(Stage parentStage) {
    ...
    public PauseMenu withOnReturnToGameClickAction(OnOkClick onOkClick) {
        this.onReturnToGame = onOkClick;
        return this;
    }

    public PauseMenu withOnGoToMainMenuClickAction(OnOkClick onOkClick) {

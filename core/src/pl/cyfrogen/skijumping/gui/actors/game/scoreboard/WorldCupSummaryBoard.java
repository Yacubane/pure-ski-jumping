...
public class WorldCupSummaryBoard extends Group {
    ...
    public WorldCupSummaryBoard(int hillNum, ArrayList<WorldCupJumperData> jumpers) {
        ...
        WorldCupSummaryHeader roundSummaryHeader = new WorldCupSummaryHeader(width, cellHeight);

        ArrayList<WorldCupSummaryCell> scoreCells = new ArrayList<WorldCupSummaryCell>();

        for(int i = 0; i < jumpers.size(); i++) {
            scoreCells.add(new WorldCupSummaryCell(hillNum, jumpers.get(i), width, cellHeight));
        }
    ...
    public Group createGroup(Actor roundSummaryHeader, List<? extends Actor> scoreCells) {
        ...
        for (Actor scoreCell : scoreCells) {
